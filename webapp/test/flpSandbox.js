		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sample App",
									"targetURL": "#comibmsampleapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comibmsampleapp-display": {
								"semanticObject": "comibmsampleapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ibm.sampleapp",
									"url": sap.ui.require.toUrl("com/ibm/sampleapp")
								}
							}
						}
					}
